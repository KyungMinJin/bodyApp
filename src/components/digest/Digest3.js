...
import p18 from '../../images/그림49.png';
import p17 from '../../images/그림50.png';
import p19 from '../../images/그림51.png';
import p43 from '../../images/그림52.png';
      ...
      <View style={styles.main}>
        ...
        <View style={styles.back2}>
          ...
          <View style={{flexDirection: 'row'}}>
            <Image
              source={p18}
              style={{resizeMode: 'contain', height: '33%'}}
            />
            <View>
              <Image
                source={p17}
                style={{resizeMode: 'contain', width: '43%'}}
              />
              <Image
                source={p19}
                style={{resizeMode: 'contain', height: '33%', right: '20%'}}
              />
            </View>
          </View>
          <Image
