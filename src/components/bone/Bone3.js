...
import p23 from '../../images/그림23.png';
import p18 from '../../images/그림24.png';
import p19 from '../../images/그림25.png';
import {TouchableOpacity} from 'react-native-gesture-handler';
import Tab from '../common/Tab';
const Bone3 = ({navigation}) => {
  return (
      ...
      <View style={styles.main}>
        ...
        <View style={styles.back2}>
          ...
          <View style={{flexDirection: 'row'}}>
            <TouchableOpacity onPress={() => navigation.navigate('Bone4')}>
              <Image source={p23} />
            </TouchableOpacity>
